 ...
 * Optional env vars:
 *   VAPID_PUBLIC_KEY (Web Push VAPID public key — public, safe for frontend)
...
window.VAPID_PUBLIC_KEY = "${process.env.VAPID_PUBLIC_KEY || process.env.VITE_VAPID_PUBLIC_KEY || ''}";
`;
